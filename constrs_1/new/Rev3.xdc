...
set_false_path -through [get_ports BTNR]
...
set_property -dict { PACKAGE_PIN "A21"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { newSW[0] }];                   # IO_L21N_T3_DQS_16             Sch = DP1
#set_property -dict { PACKAGE_PIN "E22"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { sw[2] }];                   # IO_L22P_T3_16                 Sch = DP2
set_property -dict { PACKAGE_PIN "D22"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { online }];                   # IO_L22N_T3_16                 Sch = DP3
#set_property -dict { PACKAGE_PIN "E21"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { sw[4] }];                   # IO_L23P_T3_16                 Sch = DP4
set_property -dict { PACKAGE_PIN "D21"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { newSW[1] }];                   # IO_L23N_T3_16                 Sch = DP5
set_property -dict { PACKAGE_PIN "G21"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { newSW[2] }];                   # IO_L24P_T3_16                 Sch = DP6
set_property -dict { PACKAGE_PIN "G22"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { newSW[3] }];                   # IO_L24N_T3_16                 Sch = DP7